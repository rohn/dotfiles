...
# PROMPT='%{$reset_color%}%{$fg[cyan]%}%~:%{$reset_color%}$(git_time_since_commit)$(git_prompt_info)
# %{$fg[magenta]%}%w%  %T%{$reset_color%} $(prompt_char) '

# PROMPT='%{$fg_bold[red]%}➜ %{$fg_bold[green]%}%p %{$fg[cyan]%}%c %{$fg_bold[blue]%}$(git_prompt_info)%{$fg_bold[blue]%} % %{$reset_color%}'
PROMPT='${smiley}$(git_prompt_status)%{$reset_color%} %{$reset_color%}%{$fg[cyan]%}%~:%{$reset_color%}$(git_prompt_info)
%{$fg[magenta]%}%w%  %T%{$reset_color%} $(prompt_char) '
